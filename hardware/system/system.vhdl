...
architecture rtl of system is
  ...
  signal spi_tx_data_signal : std_logic_vector(7 downto 0);
  signal spi_rx_data_signal : std_logic_vector(7 downto 0);
  signal device_id_signal   : std_logic_vector(7 downto 0);

  -- New signal for the synchronized slow clock
  signal slow_clk_signal    : std_logic;

begin

  -- 1. Generate the system-wide slow clock
  clk_div : entity work.system_clk_divider
    port map
    (
      clk        => clk,
      reset      => reset,
  ...
  -- 2. Run the controller on the slow clock
  ...
  -- 3. Run the SPI reader on the slow clock
